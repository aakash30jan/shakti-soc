...
set mcs $core_project_dir/$top_module
...
set_property PROGRAM.FILES [list ${mcs}_primary.mcs ${mcs}_secondary.mcs ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcvu9p_0] 0]]
set_property PROGRAM.PRM_FILE {} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcvu9p_0] 0]]
