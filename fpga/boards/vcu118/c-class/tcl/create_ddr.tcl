...
if { [get_ips -quiet vcu118mig] eq "" } {
    create_ip -vendor xilinx.com -library ip -version 2.2 -name ddr4 -module_name vcu118mig 
} else {
...
generate_target {instantiation_template} [get_ips vcu118mig]
create_ip_run [get_ips vcu118mig]
