...
#For VCU118 Revision 1.1 use:
#set_property board_part xilinx.com:vcu118_es1:part0:1.2 [current_project]
...
if {[string equal [get_runs -quiet core_impl_1] ""]} {
 ...
 "vcu118" -constrset constrs_1 -parent_run core_synth_1 core_impl_1
} else {
